...
const decisionDisplay = document.getElementById("decision-bubble");

const sctx = document.getElementById("confidenceChart").getContext("2d");
let confidenceChart = new Chart(ctx, {
  type: "doughnut",
  data: {
    ...
    datasets: [{
      label: "AI Confidence",
      data: [0, 0, 0],
      backgroundColor: ["#00ffd5", "#ffcc00", "#ff0044"],
      borderColor: "#222",
      borderWidth: 1
    }]
  },
...
function updateDashboard(data) {
  voltageDisplay.textContent = data.voltage + " V";
  currentDisplay.textContent = data.current + " A";
  decisionDisplay.textContent = "AI Decision: " + data.ai_output + " (" + data.reason + ")";

  confidenceChart.data.datasets[0].data = [
    data.confidence.solar,
    data.confidence.battery,
